...
"join u.roles r WHERE u=:user and r.name=tn.dari.spring.enumeration.Usertype.ADMIN")
	...
	@Query(nativeQuery = true, value ="Select :area*city.pricemetre From user,city,user_roles "
			...
			+ "and user_roles.user_id=:#{#user.idUser} and user_roles.role_id=4"
	...
	@Query(nativeQuery = true, value ="Select :builda*city.price_build From user,city "
			+ "Where user.id_user=:#{#user.idUser} and user.user_state=true "
	...
	@Query(nativeQuery = true, value ="Select :builda*city.price_build*1.75 From user,city "
	...
	/////####house
	////////////////////////////::::Famous::::////////////////////////
	@Query(nativeQuery = true, value ="Select (:builda*city.price_build)*1.75+(:area-:builda)*city.pricemetre From user,city "
			+ "Where user.id_user=:#{#user.idUser} and user.user_state=true and city.famous=true "
	...
	@Query(nativeQuery = true, value ="Select (:builda*city.price_build)+(:area-:builda)*city.pricemetre From user,city "
	...
	@Query(nativeQuery = true, value ="Select price_rent*:nber_rooms From user,city "
			+ "Where user.id_user=:#{#user.idUser} and user.user_state=true and city.famous=false "
	...
	@Query(nativeQuery = true, value ="Select price_rent*:nber_rooms*0.7 From user,city "
			+ "Where user.id_user=:#{#user.idUser} and user.user_state=true and city.famous=false "
			+ " And city.name=Lower(:city) ")
	...
	@Query(nativeQuery = true, value ="Select price_rent*:nber_rooms*0.8 From user,city "
			+ "Where user.id_user=:#{#user.idUser} and user.user_state=true and city.famous=true "
			+ " And city.name=Lower(:city) ")
	...
	@Query(nativeQuery = true, value ="Select price_rent*:nber_rooms*0.5*1.1 From user,city "
			+ "Where user.id_user=:#{#user.idUser} and user.user_state=true and city.famous=true "
			+ " And city.name=Lower(:city) ")
...
@Query(nativeQuery = true, value ="Select city.estimation_duration From user,city,user_roles "
		+ "Where user.id_user=:#{#user.idUser} and user.user_state=true and user_roles.role_id=4 "
